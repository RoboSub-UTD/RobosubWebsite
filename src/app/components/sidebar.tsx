...
export default function SideBar({ isSidebarOpen, toggleSidebar, scrollToSection, user, logOut }: {isSidebarOpen: boolean, toggleSidebar: any, scrollToSection: any, user: boolean, logOut: any}) {
